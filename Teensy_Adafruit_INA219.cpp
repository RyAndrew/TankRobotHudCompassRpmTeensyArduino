/*!
 * @file Teensy_Adafruit_INA219.cpp
 *
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::wireWriteRegister (uint8_t reg, uint16_t value)
{
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::wireReadRegister(uint8_t reg, uint16_t *value)
{
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::setCalibration_32V_2A(void)
{
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::setCalibration_32V_1A(void)
{
  // By default we use a pretty huge range for the input voltage,
  // which probably isn't the most appropriate choice for system
  // that don't use a lot of power.  But all of the calculations
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::setCalibration_16V_400mA(void) {
...
*/
/**************************************************************************/
Teensy_Adafruit_INA219::Teensy_Adafruit_INA219(uint8_t addr) {
  ina219_i2caddr = addr;
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::begin(i2c_t3* theWire) {
  _i2c = theWire;
  init();
}
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::begin(void) {
  _i2c = &Wire;
  init();
}
...
*/
/**************************************************************************/
void Teensy_Adafruit_INA219::init() {
  _i2c->begin();
...
*/
/**************************************************************************/
int16_t Teensy_Adafruit_INA219::getBusVoltage_raw() {
  uint16_t value;
...
*/
/**************************************************************************/
int16_t Teensy_Adafruit_INA219::getShuntVoltage_raw() {
  uint16_t value;
...
*/
/**************************************************************************/
int16_t Teensy_Adafruit_INA219::getCurrent_raw() {
  uint16_t value;
...
*/
/**************************************************************************/
int16_t Teensy_Adafruit_INA219::getPower_raw() {
  uint16_t value;
...
*/
/**************************************************************************/
float Teensy_Adafruit_INA219::getShuntVoltage_mV() {
  int16_t value;
...
*/
/**************************************************************************/
float Teensy_Adafruit_INA219::getBusVoltage_V() {
...
*/
/**************************************************************************/
float Teensy_Adafruit_INA219::getCurrent_mA() {
...
*/
/**************************************************************************/
float Teensy_Adafruit_INA219::getPower_mW() {
